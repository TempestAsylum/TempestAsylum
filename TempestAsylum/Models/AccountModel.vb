...
#Region "PersonalInformation"
    ...
    Private _DateOfBirth As Integer
    ...
    Public Property DateOfBirth As Integer
        Get
            Return _DateOfBirth
        End Get
    ...
    <Display(Name:="Cellphone Number")> _
