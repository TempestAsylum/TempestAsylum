...
Public Class TournamentModel
    ...
    Private Sub GetDGLInfo()
        Dim _HtmlNodeCollection As HtmlNodeCollection = WebPage.GetNodes(WebPage.GetHTMLString("http://www.dogamingleague.co.za/stage.php?id=521"), "champion", "/html[1]/body[1]/div[2]/div[1]/table[1]//table[1]")
